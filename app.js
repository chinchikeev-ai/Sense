...
const brand=`<a class="brand" href="./index.html" aria-label="Sense — главная">${icon('cube')}Sense</a>`;
...
<section class="hero home-screen home-delivery">
  ...
  <div class="hero-inner">
    <div class="hero-content">
      <h1 class="reveal">Доставка грузов<br>из Китая<br><span>в Россию</span></h1>
      <p class="hero-copy reveal delay">Забираем груз у поставщика, консолидируем, оформляем и доставляем в ваш город. Один маршрут — один ответственный менеджер.</p>
      ...
      <div class="hero-bottom">
        ...
        <div><strong>Под ключ</strong><small>от склада до двери</small></div>
      </div>
    </div>
  ...
  <div class="home-screen-inner">
    ...
    <div class="home-calc-grid">
      <form class="panel home-calc-form reveal" id="homeCalcForm">
        <div class="panel-head"><h3>Параметры груза</h3><span class="badge">Живой расчёт</span></div>
        <div class="fields">
          <div class="field">
